<template>
    <div class="p-4 flex flex-col items-center w-full max-w-3xl mx-auto">
        ...
        <!-- Bottom: Entry List + Pie Chart -->
        <div class="w-full bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-md shadow-black/5 flex flex-col">
            ...
            <div v-else class="flex flex-col sm:flex-row gap-8 items-start w-full">
                ...
                <div class="flex-1 w-full space-y-2 max-h-64 overflow-y-auto pr-1">
                    ...
                    >
                        <div class="flex flex-col flex-1 min-w-0">
                            <span class="text-xs font-semibold text-slate-700 dark:text-orange-50">
                        ...
                        <span class="font-mono text-xs text-slate-500 dark:text-orange-50/60 shrink-0">
                ...
                <div class="flex flex-col items-center shrink-0">
                    ...
                    <div class="mt-4 flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-300 w-full">
                        <div
...
// ── Pie slices grouped by description ────────────────────────────────────────
...
const timelineChartData = computed(() => {
    ...
    const finalLabels = timeframe.value === 'month' ? labels.filter((_, i) => durationData[i] > 0) : labels
    const finalData = timeframe.value === 'month' ? durationData.filter(v => v > 0) : durationData
