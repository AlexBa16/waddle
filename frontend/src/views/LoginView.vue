<template>
    ...
    >
        <div class="relative w-screen h-screen">
            ...
            >
                <div
                    class="w-full max-w-md p-8 shadow-lg bg-slate-200/75 rounded-2xl md:p-10 backdrop-blur dark:bg-slate-600/75"
                >
                    <div class="flex items-center justify-center gap-6 mb-10">
                        ...
                        />
                        <span
                            class="text-4xl font-bold md:text-5xl pop-reg text-slate-700 dark:text-orange-50"
                            >Waddle</span
                        >
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <a
                            href="/register"
                            class="text-sm underline text-slate-600 hover:text-slate-800 dark:text-orange-50 dark:hover:text-blue-100"
                        >
