            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            {{ t("nav.reports.exportModal.title") }}
                        </h2>
                        <button
                    ...
                    <div
                        class="flex flex-col gap-6 px-8 py-7 transition-all duration-200"
                    ...
                    >
                        <div class="flex flex-col gap-3">
                            ...
                            <div
                                class="grid grid-cols-4 gap-1 bg-slate-100 dark:bg-slate-700 p-1 rounded-xl"
                            >
                                <button
                        ...
                        <div
                            class="border-t border-slate-200 dark:border-slate-700 -mx-8"
                        />
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-2 mt-1">
                                ...
                                >
                                    <div
                                        class="w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors duration-150 shrink-0"
                                        :class="
                                            scope === 'me'
                                                ? 'border-[#7C86FF] bg-[#7C86FF]'
                                                : 'border-slate-300 dark:border-slate-600 group-hover:border-[#7C86FF]'
                                        "
                                        @click="scope = 'me'"
                                    >
                                        <div
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            t(
                                                "nav.reports.exportModal.scopeTeam",
                                            )
                                        }}
                                    </span>
                                </label>
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            t(
                                                "nav.reports.exportModal.scopeMember",
                                            )
                                        }}
                                    </span>
                                </label>
                        ...
                        <Transition name="slide-down">
                            <div v-if="scope === 'member'" class="-mt-2">
                                <Dropdown
                                    ...
                                    :search-placeholder="
                                        t(
                                            'nav.reports.exportModal.memberSearchPlaceholder',
                                        )
                                    "
                                    :placeholder="
                                        t(
                                            'nav.reports.exportModal.memberPlaceholder',
                                        )
                                    "
                                />
                            </div>
                    ...
                    <div class="flex items-center justify-end gap-3 px-8 pb-7">
                        ...
                        <button
                            ...
                            :class="
                                canExport
                                    ? 'bg-[#7C86FF] hover:bg-[#6c75e8] shadow-[#7C86FF]/30'
...
const canExport = computed(() => {
    ...
    if (timeframe.value === "custom" && (!customFrom.value || !customTo.value))
        return false;
    return true;
});
        ...
        if (props.isAdmin && projectStore.selected) {
            try {
                ...
                members.value = (data || []).filter(
                    (m) => !m.pending && m.name !== currentUsername,
                );
            } catch {
                members.value = [];
            }
...
async function doExport() {
    ...
    if (scope.value === "me") {
        ...
        if (scope.value === "team") {
            ...
            entries = timeEntryStore.entries.filter(
                (e) => e.trackedBy?.username === member?.name,
            );
        }
    }
    ...
    downloadCSV(
        ...
        `${projectName}-${scopeSuffix}-${timeframeSuffix}.csv`,
    );
