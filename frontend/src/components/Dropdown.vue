    ...
    <div class="relative w-full" ref="wrapperRef">
        ...
        <Transition name="dropdown">
            ...
            >
                ...
                <ul
                    class="flex flex-col gap-1 overflow-y-auto grow pr-1 specify-scrollbar"
                >
                    <li
                    ...
                    <li
                        ...
                        class="px-3 py-4 text-xs text-center text-orange-100/50 italic"
                    >
...
const selectedLabel = computed(() => {
    const found = safeOptions.value.find(
