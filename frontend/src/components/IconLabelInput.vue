<template>
    <div class="flex w-1/2 gap-6 px-6 py-5 mt-5 mb-3 bg-[#dde3ef] rounded-2xl shadow-md shadow-black/10" :class="bigField
        ...
        <select v-if="select" :value="modelValue" @change="emit('update:modelValue', $event.target.value)" class="...">
