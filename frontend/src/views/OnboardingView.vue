            ...
            <div class="flex flex-col gap-2">
                <button @click="showCreateForm = true"
                    ...
                    <div class="cursor-pointer">
                        <p class="text-sm font-semibold text-slate-700 dark:text-orange-50">{{
                            t('onboarding.createProject') }}</p>
                        <p class="text-xs text-slate-400 dark:text-slate-300 mt-0.5">{{
                            t('onboarding.createProjectDesc') }}</p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4 ml-auto transition-colors text-slate-300 group-hover:text-slate-400" fill="none"
        ...
        <div class="w-full mb-10">
            ...
            <div class="flex flex-col gap-2">
                <RouterLink to="/settings"
                    ...
                    <div>
                        <p class="text-sm font-semibold text-slate-700 dark:text-orange-50">{{ t('onboarding.settings')
                            }}</p>
                        <p class="text-xs text-slate-400 dark:text-slate-300 mt-0.5">{{ t('onboarding.settingsDesc') }}
                        </p>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4 ml-auto transition-colors text-slate-300 group-hover:text-slate-400" fill="none"
                ...
                <RouterLink to="/inbox"
                    ...
                    <div>
                        <p class="text-sm font-semibold text-slate-700 dark:text-orange-50">{{ t('onboarding.inbox') }}
                        </p>
