<template>
    <div class="flex w-1/2 gap-6 px-6 py-5 mt-5 mb-3 bg-[#dde3ef] dark:bg-slate-600 dark:placeholder-indigo-50 dark:border-slate-400 rounded-2xl shadow-md shadow-black/10 flex-row items-center justify-between">
        <div class="flex items-center gap-3 shrink-0">
            <span class="text-sm font-bold tracking-wide text-slate-800 dark:text-orange-50">
