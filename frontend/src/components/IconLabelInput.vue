<template>
    <div
        ...
        :class="
            bigField
                ? 'flex flex-col'
                : 'flex flex-row items-center justify-between gap-5 px-6 py-4'
        "
    >
        <template v-if="!bigField">
            ...
            <div class="flex items-center gap-3 shrink-0">
                ...
                <span
                    class="text-sm font-bold tracking-wide text-slate-800 dark:text-orange-50 whitespace-nowrap"
                >
                    {{ label }}
                </span>
            </div>
