<template>
    <div
        class="flex flex-col items-center justify-start max-w-3xl min-h-full px-10 py-16 mx-auto"
    >
        ...
        <div class="w-full mb-10">
            <h2
                class="mb-4 text-xs font-semibold tracking-widest uppercase text-slate-400"
            >
                {{ t("onboarding.start") }}
            </h2>
            <div class="flex flex-col gap-2">
                ...
                >
                    ...
                    <div class="cursor-pointer">
                        <p
                            class="text-sm font-semibold text-slate-700 dark:text-orange-50"
                        >
                            {{ t("onboarding.createProject") }}
                        </p>
                        <p
                            class="text-xs text-slate-400 dark:text-slate-300 mt-0.5"
                        >
                    ...
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4 ml-auto transition-colors text-slate-300 group-hover:text-slate-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        stroke-width="2"
