<template>
    <div class="relative w-screen h-screen dark:bg-black">
        ...
        <div class="fixed inset-0 z-10 flex items-center justify-center bg-slate-200/66 backdrop-blur dark:bg-slate-600/66">
            <div>
                ...
                <form class="flex flex-col gap-1 form" @submit.prevent="register">
                    ...
                    <div v-if="v$.$error" class="mt-1 text-sm text-red-500">
                        ...
                        <p v-if="v$.email.required.$invalid">E-Mail ist erforderlich.</p>
                        <p v-if="v$.email.email.$invalid">Ungültige E-Mail-Adresse.</p>
                        <p v-if="v$.password.required.$invalid">Passwort ist erforderlich.</p>
                        <p v-if="v$.password.minLength.$invalid">Passwort muss mindestens 8 Zeichen haben.</p>
                        <p v-if="v$.passwordConfirm.sameAs.$invalid">Passwörter stimmen nicht überein.</p>
                    </div>
